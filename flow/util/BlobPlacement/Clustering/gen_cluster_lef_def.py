...
class Design:
    def __init__(self, name:str, edge_file:str, node_file:str,
        ...
        if cluster_map is not None:
            ...
            ## If cluster solution available then only run clustering:
            ...
            cluster_count = self.node_df['Cluster_id'].nunique()
    ...
    def read_node_df(self) -> None:
        ...
        ## Report node_df columns
        print(f"node_df columns: {self.node_df.columns}")
    ...
    def run_hierarchy_cluster(self, threshold:float = 0.03,
        ...
        print(f"Inst Threshold count {inst_threshold} Cluster count:{len(self.clusters)}")
        count = 0
